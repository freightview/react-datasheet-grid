...
exports.SelectionRect = react_1.default.memo(({ columnWidths, columnRights, headerRowHeight, selection, rowHeight, activeCell, hasStickyRightColumn, dataLength, viewWidth, viewHeight, contentWidth, edges, isCellDisabled, editing, expandSelection, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", Object.assign({ className: "dsg-scrollable-view-container", style: {
                    height: rowHeight(dataLength - 1).top +
                        rowHeight(dataLength - 1).height +
                        headerRowHeight,
                    width: contentWidth ? contentWidth : '100%',
                } }, { children: (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)({
                        ...
                        width: contentWidth && viewWidth
                            ...
                            : `calc(100% - ${columnWidths[0] +
                                (hasStickyRightColumn
                                    ? columnWidths[columnWidths.length - 1]
                                    : 0)}px)`,
                    } }) })), (selectionRect || activeCellRect) && ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "dsg-selection-col-marker-container", style: {
                    ...
                    height: rowHeight(dataLength - 1).top +
                        rowHeight(dataLength - 1).height +
                        headerRowHeight,
                } }, { children: (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('dsg-selection-col-marker', selectionIsDisabled && 'dsg-selection-col-marker-disabled'), style: { top: headerRowHeight } }) }))), (selectionRect || activeCellRect) && ((0, jsx_runtime_1.jsx)("div", Object.assign({ className: "dsg-selection-row-marker-container", style: {
                    ...
                    width: contentWidth ? contentWidth : '100%',
                } }, { children: (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('dsg-selection-row-marker', selectionIsDisabled && 'dsg-selection-row-marker-disabled'), style: { left: columnWidths[0] } }) }))), activeCellRect && activeCell && ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('dsg-active-cell', {
                    'dsg-active-cell-focus': editing,
                    'dsg-active-cell-disabled': activeCellIsDisabled,
                }), style: activeCellRect })), selectionRect && activeCellRect && ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('dsg-selection-rect', selectionIsDisabled && 'dsg-selection-rect-disabled'), style: Object.assign(Object.assign({}, selectionRect), { clipPath: buildClipPath(activeCellRect.top - selectionRect.top, activeCellRect.left - selectionRect.left, activeCellRect.top + activeCellRect.height - selectionRect.top, activeCellRect.left + activeCellRect.width - selectionRect.left) }) })), expandRowsRect && ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('dsg-expand-rows-rect'), style: expandRowsRect })), expandRowsIndicator && ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('dsg-expand-rows-indicator', selectionIsDisabled && 'dsg-expand-rows-indicator-disabled'), style: expandRowsIndicator }))] }));
});
