...
exports.StaticDataSheetGrid = react_2.default.forwardRef((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)(DataSheetGrid_1.DataSheetGrid, Object.assign({}, staticProps, rest, { rowHeight: typeof rowHeight === 'number' ? rowHeight : staticProps.rowHeight, ref: ref })));
});
